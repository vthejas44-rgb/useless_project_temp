...
For deep-dive data flows and component specifications, consult [architecture.md](file:///.agents/skills/reverse-shell-skill/references/architecture.md).
...
For extension guidelines and complete registry structure, consult [command-mapping.md](file:///.agents/skills/reverse-shell-skill/references/command-mapping.md).
...
For complete step-by-step test scripts and output specs, consult [demo-scenarios.md](file:///.agents/skills/reverse-shell-skill/references/demo-scenarios.md).
...
- [Architecture & Data Flow](file:///.agents/skills/reverse-shell-skill/references/architecture.md)
- [Command Registry & Mappings](file:///.agents/skills/reverse-shell-skill/references/command-mapping.md)
- [Demo Scenarios & Output Formats](file:///.agents/skills/reverse-shell-skill/references/demo-scenarios.md)
