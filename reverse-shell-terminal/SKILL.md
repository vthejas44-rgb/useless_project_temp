...
For detailed architectural sequence diagrams and component contracts, consult [architecture.md](file:///reverse-shell-terminal/references/architecture.md).
...
For step-by-step PTY code patterns, consult [pty-and-shell.md](file:///reverse-shell-terminal/references/pty-and-shell.md).
...
For full command mapping registry definitions and extension rules, consult [command-mapping.md](file:///reverse-shell-terminal/references/command-mapping.md).
...
For security rules and boundary details, consult [security.md](file:///reverse-shell-terminal/references/security.md).
...
For UI layout specs and Qt stylesheet definitions, consult [terminal-ui.md](file:///reverse-shell-terminal/references/terminal-ui.md).
...
For test specs and packaging commands, consult [testing.md](file:///reverse-shell-terminal/references/testing.md).

---

## 9. Progressive Disclosure Reference Links

- [Architecture & Sequence Diagrams](file:///reverse-shell-terminal/references/architecture.md)
- [PTY & Shell Process Management](file:///reverse-shell-terminal/references/pty-and-shell.md)
- [Command Registry & 2-Tier Translation](file:///reverse-shell-terminal/references/command-mapping.md)
- [PySide6 Terminal UI Design](file:///reverse-shell-terminal/references/terminal-ui.md)
- [Security & Workspace Boundaries](file:///reverse-shell-terminal/references/security.md)
- [Testing & Linux Packaging](file:///reverse-shell-terminal/references/testing.md)
